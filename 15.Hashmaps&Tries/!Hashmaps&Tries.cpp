...
// compression functions works it to bring the numeric value inside the range (i.e it applies mod to the numeric value to bring it in range eg:the range is 0 to 4 if the numeric value is 22 then it will apply modulos and make it 2
*//Collision
...
*//Open Hashing*
// so when there is a value tring to be place on a index but there is already a value so then u save both values in linked list by creating  a linked list adding the values to it and then storing the head of it to the main array
