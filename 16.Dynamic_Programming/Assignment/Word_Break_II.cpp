...
// add space in between the word and endPart and push_back it into the ans
  *//this question is can be solved using trie please try it on ur own
  *//applying botttom up solution is a lil difficult and not recummended and memoisation makes more sense
